...
/datum/controller/subsystem/job/proc/generate_individual_objectives(datum/mind/crewMind)
	...
	to_chat(crewMind, "<B>As a part of GATO's anti-tide efforts, you have been assigned an optional objective. It will be checked at the end of the shift. <span class='warning'>Performing traitorous acts in pursuit of your objective may result in termination of your employment.</span></B>")
