...
/datum/artifact_effect/insanity_pulse/proc/pulse(datum/source, mob/living/pulser)
	...
	if(first_time)
		...
		priority_announce("Spacetime anomaly detected at [T.loc]. Data analysis completed, [research_reward] research points rewarded.", "GATO Research Division", ANNOUNCER_SPANOMALIES)
