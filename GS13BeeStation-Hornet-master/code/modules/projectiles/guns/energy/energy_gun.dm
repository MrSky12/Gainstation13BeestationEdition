...
/obj/item/gun/energy/e_gun/mini/heads
	...
	desc = "The PTSD gun has a built-in flashlight and the ability to recharge itself in two minutes. PTSD is standard issue for leadership within GATO. It has two settings: disable and kill."
